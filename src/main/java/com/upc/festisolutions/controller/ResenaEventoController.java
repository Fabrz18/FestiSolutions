...
public class ResenaEventoController {
    ...
    @GetMapping("/reseñaeventos/idAnfitrion/idEvento/{idAnfitrion}/{idEvento}")
    @PreAuthorize("hasRole('ANFITRION')")
    public List<ResenaEventoDTO> listarResenaEventoSegunAnfitrionYEvento(@PathVariable Integer idAnfitrion, @PathVariable Integer idEvento){
        return iResenaEventoService.listarResenaEventoSegunAnfitrionYEvento(idAnfitrion, idEvento);
    }
}
