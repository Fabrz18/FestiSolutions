...
public class ContratoEventoController {
    ...
    public List<ContratoEventoDTO> historialEventoSegunAnfitrionPorFechaMasAntigua(@PathVariable Integer idAnfitrion){
    ...
    @PreAuthorize("hasRole('ANFITRION')")
    public List<ContratoEventoDTO> historialEventoSegunAnfitrionPorFechaMasReciente(@PathVariable Integer idAnfitrion){
    ...
    @PreAuthorize("hasRole('ANFITRION')")
    public List<ContratoEventoDTO> historialEventoSegunAnfitrionPorMayorPresupuesto(@PathVariable Integer idAnfitrion){
    ...
    @PreAuthorize("hasRole('ANFITRION')")
    public List<ContratoEventoDTO> historialEventoSegunAnfitrionPorMenorPresupuesto(@PathVariable Integer idAnfitrion){
    ...
    @PreAuthorize("hasRole('ANFITRION')")
    public List<ContratoEventoDTO> historialEventoSegunAnfitrionPorMejorValoracion(@PathVariable Integer idAnfitrion) {
    ...
    @PreAuthorize("hasRole('ANFITRION')")
    public List<ContratoEventoDTO> historialEventoSegunAnfitrionPorPeorValoracion(@PathVariable Integer idAnfitrion){
    ...
    public List<ContratoEventoDTO> historialContratosSegunProveedorPorFechaMasReciente(@PathVariable Integer idProveedor){
    ...
    @PreAuthorize("hasRole('PROVEEDOR')")
    public List<ContratoEventoDTO> historialContratosSegunProveedorPorFechaMasAntigua(@PathVariable Integer idProveedor){
    ...
    @PreAuthorize("hasRole('PROVEEDOR')")
    public List<ContratoEventoDTO> historialContratosSegunProveedorPorMayorPresupuesto(@PathVariable Integer idProveedor){
    ...
    @PreAuthorize("hasRole('PROVEEDOR')")
    public List<ContratoEventoDTO> historialContratosSegunProveedorPorMenorPresupuesto(@PathVariable Integer idProveedor){
    ...
    @PreAuthorize("hasRole('PROVEEDOR')")
    public List<ContratoEventoDTO> historialContratosSegunProveedorPorMejorValoracion(@PathVariable Integer idProveedor){
    ...
    @PreAuthorize("hasRole('PROVEEDOR')")
    public List<ContratoEventoDTO> historialContratosSegunProveedorPorPeorValoracion(@PathVariable Integer idProveedor){
    ...
    @GetMapping("/eventos/actuales/anfitrion/{idAnfitrion}")
    @PreAuthorize("hasRole('ANFITRION')")
    ...
    @GetMapping("/contrato/actuales/proveedor/{idProveedor}")
    @PreAuthorize("hasRole('PROVEEDOR')")
